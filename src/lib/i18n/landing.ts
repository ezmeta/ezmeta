...
export const landingDictionary = {
  bm: {
    ...
    starterSubtitle: 'Pemantauan Asas',
    proSubtitle: 'Automasi & Winning Ads',
    agencySubtitle: 'Skalabiliti & Multi-client Management',
  ...
  en: {
    ...
    starterSubtitle: 'Core Monitoring',
    proSubtitle: 'Automation & Winning Ads',
    agencySubtitle: 'Scalability & Multi-client Management',
